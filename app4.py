...
.aqi-big-number {
    font-family: 'Syne', sans-serif;
    /* clamp: never below 3.5rem, scales with viewport, caps at 5.5rem */
...
.thin-divider { border: none; border-top: 1px solid rgba(255,255,255,0.06); margin: 1.5rem 0; }
.app-footer { font-size: 0.75rem; color: rgba(255,255,255,0.2); margin-top: 2.5rem; }
